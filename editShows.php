...
$id=$_GET['id'];
$sql="SELECT * FROM `show_list` WHERE id=".$id;
$t=$s->select($sql);
$show=$t['result'][0];
            ...
            <div class="container projects">
                ...
                <div id="register_body" class="row">
                    <div   class="col-md-6 col-md-offset-3">
                        <form class="form-horizontal" action="./deal/editShows.php" method="post" enctype="multipart/form-data" id="register-form" >
                            <div class="form-group">
                                <label for="inputDes" class="col-sm-2 control-label">名称</label>
                                <div class="col-sm-10">
                                    <input id='showId'  name="showId" type="hidden" value="<?php echo $id;?>">
                                    <input id='name'  name="name" type="text" class="form-control" placeholder="请输入名称" value="<?php echo $show['title'];?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id='detail' name="detail" class="form-control" rows="8"  placeholder="不超过1000字"><?php echo $show['content'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
