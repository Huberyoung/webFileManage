        ...
        <div class="col-md-12 column">
            ...
            <div class="container projects">
                <div class="projects-header page-header">
                    <span class="h3">资源上传</span>
                </div>
                <!--文件上传框-->
                <div id="register_body" class="row">
                    <div   class="col-md-6 col-md-offset-3">
                        <form class="form-horizontal" action="./deal/files_upload.php" method="post" enctype="multipart/form-data" id="register-form" >
                            <div class="form-group">
                                <label for="inputDes" class="col-sm-2 control-label">名称</label>
                                <div class="col-sm-10">
                                    <input id='name'  name="name" type="text" class="form-control" placeholder="请输入文件名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPic" class="col-sm-2 control-label">文件</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id='des' name="des" class="form-control" rows="2"  placeholder="不超过30字"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputDes" class="col-sm-2 control-label">详情介绍</label>
                                <div class="col-sm-10">
                                    <textarea id='detail' name="detail" class="form-control" rows="5"  placeholder="不超过300字"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">价值</label>
                                <div class="col-sm-10">
                                    <input id='price'  name="price" type="text" class="form-control" placeholder="请输入文件价值">
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    $(function () {
        $('#register-form').submit(function () {
            ...
            if ( pic == '' ||  pic.length <= 0) {
                layer.tips('请选择文件', '#pic', {time: 2000, tips: 2});
                $('#pic').focus();
                return false;
            }
